...
export class CreateUserDto {
  ...
  @ApiProperty({ description: 'User role', enum: UserRole, example: UserRole.CANDIDATE })
  @IsEnum(UserRole, { message: 'Rôle invalide. Valeurs acceptées: super_admin, hr, candidate' })
