  ...
  <section class="space-y-4">
    ...
    <div v-if="resumeUrl" class="flex flex-col items-center gap-3 py-4">
      ...
      <div class="flex gap-6">
        <a :href="resumeUrl" target="_blank" class="text-sm text-cyan-600 hover:underline flex items-center gap-1">👁️ Voir</a>
        <a :href="resumeUrl" download class="text-sm text-cyan-600 hover:underline flex items-center gap-1">⬇️ Télécharger</a>
      </div>
    </div>

    <p v-else class="text-sm text-slate-500 italic pl-1">
