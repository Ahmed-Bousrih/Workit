<template>
  <div class="min-h-screen bg-white dark:bg-slate-900 text-slate-800 dark:text-slate-100">
    ...
    <section class="bg-slate-100 dark:bg-slate-800 p-6 rounded-xl shadow">
      <div class="flex justify-between items-center cursor-pointer" @click="showPasswordForm = !showPasswordForm">
    ...
    <!-- Delete Account -->
    <section class="bg-red-100 dark:bg-red-900 p-6 rounded-xl shadow text-red-800 dark:text-red-200">
      ...
      <div v-else class="bg-white dark:bg-slate-800 text-slate-800 dark:text-white p-4 rounded-xl mt-4 space-y-4">
