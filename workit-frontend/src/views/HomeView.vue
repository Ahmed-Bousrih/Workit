<template>
  <div class="min-h-screen bg-white text-slate-800 flex flex-col dark:bg-slate-900 dark:text-slate-100">
    ...
    <main class="flex-grow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
      ...
      <p class="text-slate-600 dark:text-slate-300 max-w-2xl mx-auto mb-12 text-lg">
        ...
        Découvrez les opportunités qui vous attendent et rejoignez une entreprise engagée et innovante.
      </p>
      ...
      <div class="grid md:grid-cols-3 gap-8 mb-16">
        <div class="p-6 bg-slate-100 dark:bg-slate-800 rounded-2xl shadow hover:shadow-lg transition">
          <h3 class="font-semibold text-xl text-cyan-700 dark:text-cyan-400 mb-2">Opportunités Diversifiées</h3>
          <p class="dark:text-slate-300">Des postes adaptés à différents profils et parcours, au sein des équipes MedTrust.</p>
        </div>
        <div class="p-6 bg-slate-100 dark:bg-slate-800 rounded-2xl shadow hover:shadow-lg transition">
          <h3 class="font-semibold text-xl text-cyan-700 dark:text-cyan-400 mb-2">Recrutement Simplifié</h3>
          <p class="dark:text-slate-300">Postulez rapidement et suivez vos candidatures en toute transparence.</p>
        </div>
        <div class="p-6 bg-slate-100 dark:bg-slate-800 rounded-2xl shadow hover:shadow-lg transition">
          <h3 class="font-semibold text-xl text-cyan-700 dark:text-cyan-400 mb-2">Accès Sécurisé</h3>
          <p class="dark:text-slate-300">Connexion simple et sécurisée pour les candidats et les recruteurs internes.</p>
        </div>
      </div>

      <!-- Stats Section -->
      <div class="flex flex-col sm:flex-row justify-center gap-12 text-cyan-700 dark:text-cyan-400 font-semibold text-center">
        <div>
